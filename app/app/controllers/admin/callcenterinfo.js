app.controller('callCenterCtrl', function($scope,$http,toastr,AdminContactService,$mdDialog,$rootScope) {
      ...
      $scope.gridcallCenter = {  
       ...
       $scope.gridcallCenter.columnDefs = [
            ...
            cellTemplate: '<div class="ui-grid-cell-contents"><button id="feedbackButton{{row.entity.id}}" ng-style="row.entity.call_feedback && {\'background-color\':\'limegreen\'} " class="btn btn-small" ng-click="grid.appScope.CallFeedback(row.entity)">Call Feedback</button><span><a href="" ng-click="grid.appScope.deleteCallCenterInfo(row.entity)"><md-icon><i class="material-icons">delete</i></md-icon></a></span></div>',
